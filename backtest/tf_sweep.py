...
async def sweep_symbol(
    ...
    from strategy.nlm_engine import NLMStrategyEngine as EngineClass
...
async def main():
    ...
    parser.add_argument('--engine', default='nlm', choices=['nlm'],
                        help="Strategy engine (dedicated project: NLM only)")
